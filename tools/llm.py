...
18. Renaming a function/symbol? Replace ALL its occurrences: the definition AND every call/use (one edit per occurrence), then read the file and check the old name is completely gone.
"""
